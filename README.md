...
# [social-change] - Código de Conducta

## 1. Propósito

Uno de los objetivos principales de `social-change - proyecto 26` es apartir del software generar cambios en nuestras sociedades, buscando crear soluciones de alto impacto a los problemas sociales que tenemos en nuestros paises, problemas como corrupcion, pobreza o seguridad.

Buscar el mayor número de contribuyentes, con la mayor diversidad de orígenes posibles.
...
En la comunidad `Proyecto 26` nos esforzamos por ir un paso más allá y cuidar 
...
hacer que sus compañeras y compañeros de `proyecto 26` estén cómodos.
